/**
 * Tests for useProposeResolution hook
 */
...
import { useProposeResolution } from '../../../hooks/resolution/useProposeResolution';
...
describe('useProposeResolution', () => {
  ...
  it('should propose resolution successfully', async () => {
    const { result } = renderHook(() => useProposeResolution(1), { wrapper });
  ...
  it('should handle errors gracefully', async () => {
    if (mockWalletClient.writeContract) {
      vi.mocked(mockWalletClient.writeContract).mockRejectedValue(new Error('Bond too low'));
    }
